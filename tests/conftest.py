"""pytest configuration for the Slovak Parcel Service test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.slovak_parcel_service`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.slovak_parcel_service import parcels

    parcels._unmapped_statuses_logged.clear()
    parcels._info_shape_warned.clear()
    yield
