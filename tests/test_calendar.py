"""Tests for the Slovak Parcel Service deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.slovak_parcel_service.calendar import (
    SlovakParcelServiceDeliveriesCalendar,
)
...
def _cal(data):
    return SlovakParcelServiceDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="Slovak Parcel Service Shop")])
    assert cal._events()[0].location == "Slovak Parcel Service Shop"
